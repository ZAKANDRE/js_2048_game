...
function updateUI() {
    ...
    if (game.status === "lose") messageLose.classList.remove("hidden");
    else if (game.status === "win") messageWin.classList.remove("hidden");
    if (game.status === "playing" || game.status === "lose" || game.status === "win") {
...
window.addEventListener("keydown", (e)=>{
    ...
    if (oldBoard !== JSON.stringify(game.board)) updateUI();
});

},{"../modules/Game.class.js":"eIbh2"}],"eIbh2":[function(require,module,exports) {
 ...
 */ parcelHelpers.export(exports, "Game", ()=>Game) // module.exports = Game;
;
"use strict";
class Game {
    /**
   ...
   */ constructor(initialState){
    ...
    moveLeft() {
        ...
        const prevState = this.getState().map((row)=>[
                ...row
            ]);
        for(let r = 0; r < 4; r++){
